/*
 * Question: Max and Second Max
 * Given an array arr[] of size n, return an array containing the largest and the second largest elements. If no second largest element exists (all elements are equal), return -1 in its place.
 *
 * Examples:
 * Input: arr[] = [10, 5, 8]
 * Output: [10, 8]
