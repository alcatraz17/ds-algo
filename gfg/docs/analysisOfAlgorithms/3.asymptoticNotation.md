...
Asymptotic notation is a way to describe the performance of algorithms as their input size grows. It provides a high level understanding of
...
- **Think of it as**: "No matter what, it will be _at most_ this slow."
- **Simple examples**:
...
- **Think of it as**: "Even in the best situation, it is _at least_ this slow."
- **Simple examples**:
...
- **Think of it as**: "This is the _exact_ growth trend (ignoring constants)."
- **Simple examples**:
...
- This means the function's runtime grows linearly with the input size.
